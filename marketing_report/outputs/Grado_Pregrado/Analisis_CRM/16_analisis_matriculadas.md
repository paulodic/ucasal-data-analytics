...
## Números Globales
- **Total de Leads Analizados:** 369,148
- **Leads marcados como 'Matriculados = 1' en Salesforce:** 5,712
- **Inscriptos Reales Verificados (Cruce Exacto + Fuzzys confiables):** 188
...
- **Diferencia Neta en Volumen (Reporte CRM vs Reporte Base de Datos Real):** 5,524 inscriptos faltantes en el reporte superficial.
- **Leads que generaron una venta real y que el CRM NO se está atribuyendo:** 5,851 ventas "ciegas" en Salesforce.
- **Total de expedientes discordantes a auditar:** 5,890 personas que tienen un estado de vida opuesto entre ambos sistemas informáticos.
