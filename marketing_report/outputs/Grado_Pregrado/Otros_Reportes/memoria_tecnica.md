...
| Métrica | Valor |
|---|---|
| Personas únicas analizadas | 305,232 |
| Personas inscriptas (con pago confirmado) | 7,937 |
| Personas no inscriptas | 297,295 |
| Promedio consultas por persona | 1.3 |
| Promedio días hasta inscripción | 59.4 |
