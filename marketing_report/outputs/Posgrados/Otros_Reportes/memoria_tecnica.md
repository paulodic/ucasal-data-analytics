...
| Métrica | Valor |
|---|---|
| Personas únicas analizadas | 145 |
| Personas inscriptas (con pago confirmado) | 100 |
| Personas no inscriptas | 45 |
| Promedio consultas por persona | 1.2 |
| Promedio días hasta inscripción | 133.0 |
