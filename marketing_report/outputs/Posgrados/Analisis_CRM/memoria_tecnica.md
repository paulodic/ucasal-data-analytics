...
| Métrica | Valor |
|---|---|
| Total Leads analizados | 157 |
| Leads con Matriculadas=1 en CRM | 1 |
| Inscriptos reales cruzados (verificados) | 34 |
| **Falsos positivos CRM** (marcados pero no inscriptos) | 1 |
| **Falsos negativos CRM** (inscriptos pero no marcados) | 34 |
| Diferencia bruta (CRM - Real) | 33 |
...
| Huérfanos (sin traza en CRM) | 239 |
