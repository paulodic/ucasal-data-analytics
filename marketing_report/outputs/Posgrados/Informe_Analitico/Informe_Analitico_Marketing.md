...
## 1. Resumen Ejecutivo
Se analizaron un total de **191** leads únicos y **325** inscriptos únicos para identificar qué campañas e interacciones previas generaron las inscripciones finales.

| Métrica | Valor |
|---------|-------|
| Total Leads | 191 |
| Total Inscriptos | 325 |
| Inscriptos Atribuidos a un Lead (Exacto) | 40 (12.3% del total) |
| Inscriptos sin trazabilidad | 211 |
| **Tasa de Conversión General Leads (Exacta)** | **61.26%** |
...
|------------|------------------------|-----------------------|--------------------|
| **Google Ads** | 26 | 9 | **34.62%** |
| **Meta (FB/IG)** | 88 | 47 | **53.41%** |

### Procedencia de Leads (Pagado vs Orgánico/Desconocido)
De los 191 leads capturados, se analizó cuántos poseen parámetros tracking (UTM) o provienen directamente de formularios dentro de redes (ej. Facebook Lead Ads), frente a los que no tienen este tracking:
- **Plataformas Pagadas Confirmadas:** 114 leads (59.7%)
- **Otros (Orgánico / Sin Tracking ID):** 77 leads (40.3%)

De igual manera, al observar solo las **117 inscripciones (cruces exactos)** logradas a partir de leads, la distribución de origen es:
- **Inscripciones Pagadas (Meta/UTM):** 56 (47.9%)
- **Inscripciones Orgánicas/Directas:** 61 (52.1%)

*(Nota sobre Fuzzys: Existen 74 leads sospechosos de ser inscriptos (74 inscriptos) que fueron encontrados mediante algoritmos de similitud de nombres y requieren verificación manual. NO han sido incluidos en ninguna tasa de conversión).*
...
|:-------------------|-----------:|----------:|-------:|
| Orgánicos/Directos |       13.7 |         9 |      3 |
| Pagados (Meta/UTM) |       87.2 |        97 |     33 |
...
- **Promedio de Consultas por Persona:** 1.1 veces.
- **Tiempo de Decisión Promedio:** Un usuario tarda en promedio **228.7 días** desde su primera consulta hasta que formaliza el pago.

### Principales Fuentes que Inician el Recorrido (1er Touch) en Usuarios Inscriptos:
![Top Fuentes](chart_3_top_fuentes.png)
- **Facebook Lead Ads**: 75 inscriptos
- **Desconocido**: 33 inscriptos
- **Web Orgánico (3)**: 23 inscriptos
- **Portales (4)**: 11 inscriptos
- **Origen 103**: 7 inscriptos
- **Origen 297**: 2 inscriptos
- **Origen 300**: 2 inscriptos
- **Origen 73**: 2 inscriptos
- **Chatbot (907)**: 2 inscriptos
- **Origen 390**: 1 inscriptos
...
|-------|------------------|---------------------------|
| 12/10/2025 | Domingo | 9 |
| 01/02/2026 | Domingo | 7 |
| 12/02/2025 | Miércoles | 6 |
| 12/05/2025 | Lunes | 6 |
...
| 13/01/2025 | Lunes | 0 |
| 14/01/2025 | Martes | 0 |
| 15/01/2025 | Miércoles | 0 |
| 16/01/2025 | Jueves | 0 |
| 17/01/2025 | Viernes | 0 |
| 18/01/2025 | Sábado | 0 |
| 19/01/2025 | Domingo | 0 |
| 20/01/2025 | Lunes | 0 |
| 21/01/2025 | Martes | 0 |
| 22/01/2025 | Miércoles | 0 |
| 23/01/2025 | Jueves | 0 |
| 24/01/2025 | Viernes | 0 |
| 25/01/2025 | Sábado | 0 |
| 26/01/2025 | Domingo | 0 |
| 27/01/2025 | Lunes | 0 |


**Observación sobre los valles:** El 26.7% de los días con menor volumen de inscripciones del histórico analizado coinciden directamente con fines de semana (Sábado/Domingo).
