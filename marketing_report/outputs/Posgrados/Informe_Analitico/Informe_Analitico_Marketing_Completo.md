...
## Resumen Ejecutivo
- Total Registros de Leads (Historico): 123
...
Se logro trazar el origen exacto de 52 inscriptos. La tasa de conversion real (deduplicada por persona) es de 100.00%.

### 2. Rendimiento del Chatbot (907)
El Bot presenta una tasa de conversion de 100.00%, inferior al promedio general de 100.00%. Capto 5 leads de los cuales 3 se inscribieron.
